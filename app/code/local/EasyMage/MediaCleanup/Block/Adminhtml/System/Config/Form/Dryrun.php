 ...
 */
class EasyMage_MediaCleanup_Block_Adminhtml_System_Config_Form_Dryrun extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    /**
    ...
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $buttonHtml = $this->_getAddRowButtonHtml($this->__('Dry Run'));
        return $buttonHtml;
    }
    ...
    {
        $url = Mage::helper('adminhtml')->getUrl("adminhtml/mediacleanup/dryrun");
